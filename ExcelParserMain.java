...
public class ExcelParserMain {
     ...
     */
    public static String parseExcelFile(String targetName, String[] sheetList, boolean showSheetName) {
    ...
    public static String start(String[] args) {
        ...
        if (targetName.equalsIgnoreCase("Validate")) {
            ...
            return parseExcelFile(targetName, sheetList, showSheetName);
        }
    }
